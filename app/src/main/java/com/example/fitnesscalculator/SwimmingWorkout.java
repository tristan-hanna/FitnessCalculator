...
public class SwimmingWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swimming_workout);

        ListView listView = (ListView) findViewById(R.id.swimmingWorkoutView);

        //Loads selected exercises from SwimmingActivity into an array
    ...
    //Function used to retrieve the array of selected exercises from the SwimmingActivity
    public String[] loadArray(String arrayName, Context mContext) {
        SharedPreferences prefs = mContext.getSharedPreferences("swimmingex", 0);   //Uses same key from SwimmingActivity
