...
public class WalkingWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walking_workout);

        ListView listView = (ListView) findViewById(R.id.walkingWorkoutView);

        //Loads selected exercises from WalkingActivity into an array
    ...
    //Function used to retrieve the array of selected exercises from the WalkingActivity
    public String[] loadArray(String arrayName, Context mContext) {
        SharedPreferences prefs = mContext.getSharedPreferences("walkingex", 0);    //Uses same key from WalkingActivity
